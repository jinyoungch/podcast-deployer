...
export { awsRegion, podcastUrl, s3BucketName, showTitle, showDescription, showHostName, showHostEmail, showCoverArtURL, iTunesCategory, iTunesSubCategory };